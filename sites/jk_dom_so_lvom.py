...
HEADLESS = True
SITE_NAME = 'ЖК Дом со львом'
SITE_URL = 'https://leo-development.ru/catalog/4'
SPREADSHEET_ID = '1xNWmh5ac-N7y1XTQd4_kw5TItxb6YiMlPmCdbFa8dx0'  # заказчика
SHEET_ID = 0  # заказчика
SHEET_NAME = 'Лист1'  # заказчика
# SPREADSHEET_ID = '1Zbwjq-HUZSTLBJbI2KnkZMeG0B6QQrD46BTXdvpcqhc'  # мой
# SHEET_ID = 0  # мой
# SHEET_NAME = 'Лист1'  # мой
HEADER = ['№ квартиры', 'Этаж', 'Площадь', 'Комнат', 'Цена']
