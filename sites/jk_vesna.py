...
HEADLESS = True
SITE_NAME = 'ЖК Весна'
SITE_URL = 'https://domoplaner.ru/catalog/397/tE0grI/chess/?house_id=2405'
SPREADSHEET_ID = '19K_A1jNJQOOSIA3rsT_F74eMNr_AmFvO1-eaiZf-iUk'  # заказчика
SHEET_ID = 457421444  # заказчика
SHEET_NAME = 'parser'  # заказчика
# SPREADSHEET_ID = ''  # мой
# SHEET_ID = 0  # мой
# SHEET_NAME = 'Лист1'  # мой
HEADER = ['Дом', 'Сеекция', 'Этаж', '№ квартиры', 'Тип', 'Площадь', 'Цена']
...
def pars_data(parser):
    ...
    while i < len(urls):
        ...
        for el in els:
            ...
            try:
                xpath = '/html/body/div[1]/div/div/section/div/div/div/div[1]/div/div[1]/div[3]/div[2]/div[7]/div[' \
                        '2]/span '
