...
HEADLESS = True
SITE_NAME = 'ЖК Легенда'
SITE_URL = 'https://legendavl.ru/#visual'
SPREADSHEET_ID = '1mGfN7WLza1poA4jSZzExTFUgqws0CwLP37XSODL-RG0'  # заказчика
SHEET_ID = 0  # заказчика
SHEET_NAME = 'Лист1'  # заказчика
# SPREADSHEET_ID = '1EYr69QsXKcm4P3ChMOYRbI_NVdp4_9sPZ3xd-wIDHns'  # мой
# SHEET_ID = 0  # мой
        ...
        while int(f) != 3:
            try:
                down_bt = driver.get_element(
                    (By.CSS_SELECTOR, '#floorFullContent > div.box > div.controls > div.group1 > div > div.selectBox > '
                                      'svg.svg_icon.control_down'))
                down_bt.click()
                sleep(1)
